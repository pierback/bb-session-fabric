...
declare const hostDaemonCommandRegistry: {
    ...
    "session.discovery.scan": HostDaemonCommandDescriptor<"session.discovery.scan", z$1.ZodObject<{
        codexBridgeLaunch: z$1.ZodObject<{
            capabilities: z$1.ZodObject<{
                fork: z$1.ZodEnum<{
                    checkpoint: "checkpoint";
                    none: "none";
...
declare const timelineConversationRowSchema: z$1.ZodDiscriminatedUnion<[z$1.ZodObject<{
    ...
    createdAt: z$1.ZodNumber;
    forkSourceSeqEnd: z$1.ZodNullable<z$1.ZodNumber>;
    id: z$1.ZodString;
    kind: z$1.ZodLiteral<"conversation">;
...
declare const threadConversationRoutesResponseSchema: z$1.ZodObject<{
    currentThreadId: z$1.ZodString;
    rootThreadId: z$1.ZodString;
    routes: z$1.ZodArray<z$1.ZodObject<{
        archivedAt: z$1.ZodNullable<z$1.ZodNumber>;
        createdAt: z$1.ZodNumber;
        path: z$1.ZodArray<z$1.ZodObject<{
            threadId: z$1.ZodString;
            title: z$1.ZodNullable<z$1.ZodString>;
            titleFallback: z$1.ZodNullable<z$1.ZodString>;
        }, z$1.core.$strict>>;
...
type ThreadConversationRoutesResponse = z$1.infer<typeof threadConversationRoutesResponseSchema>;
...
type EditMessageResponse = ThreadResponse;
...
type ThreadConversationRoutesResult = ThreadConversationRoutesResponse;
...
interface ThreadsArea {
    ...
    experimental_conversationRoutes(args: ThreadStatusArgs): Promise<ThreadConversationRoutesResult>;
...
interface PluginProviderCapabilities {
     ...
     */
    experimental_handoffRestatementSafety?: "isolated_no_tools" | "unsupported";
